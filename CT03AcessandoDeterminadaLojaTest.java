...
import java.net.URL;
public class CT03AcessandoDeterminadaLojaTest {
  ...
  @Test
  public void cT03AcessandoDeterminadaLoja() {
    ...
    driver.findElement(By.id("locationAutoComplete")).sendKeys("São Paulo");
    driver.findElement(By.cssSelector(".AutoComplete-result-name")).click();
    {
      List<WebElement> elements = driver.findElements(By.cssSelector(".Search-result--container-right"));
